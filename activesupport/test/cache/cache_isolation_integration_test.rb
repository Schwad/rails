...
class CacheIsolationIntegrationTest < ActiveSupport::TestCase
  # Don't use the actual cache isolation in these tests
  # We want to test it manually
  def self.prepended(base)
    # Skip the automatic cache isolation for these tests
  end
